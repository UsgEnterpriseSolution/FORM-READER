...
export default function Upload() {
  ...
  return (
    <section className="mx-4 flex h-fit max-w-[608px] flex-col gap-2 pt-10 sm:mx-auto">
      {/* Drop area */}
      <div
        ...
        className="border-input data-[dragging=true]:bg-accent/50 has-[input:focus]:border-ring has-[input:focus]:ring-ring/50 flex min-h-56 flex-col items-center rounded-xl border-2 border-dashed p-4 transition-colors not-data-[files]:justify-center has-[input:focus]:ring-[3px] data-[files]:hidden"
      >
        <input
          {...getInputProps()}
          className="sr-only"
      ...
      {files.length === 0 && (
        ...
        >
          Upload the documents you want processed.
        </p>
      )}
    </section>
  );
